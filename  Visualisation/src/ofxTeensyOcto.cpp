...
{    
    ...
    for (int x = 0; x < ledWidth; x++)
    {
        for (int y = 0; y < ledHeight; y++)
        {
         ...
         //   cout << x << " " << y << " here " << " " <<  endl;
    //        colors[loc] = ofColor(255,ofMap(ofGetMouseX(), 0, ofGetWidth(), 0, 255),255,);
//            cout << colors[loc] << endl;
        }
    }
...
{    
    for (int i=0; i < numPorts; i++){
        ...
        // convert the LED image to raw dat
